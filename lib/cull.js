var cull = (function (global) {
    ...
    /** Is `list` an object which looks like an array? */
    function isList(list) {
        return !!list && (
            toString.call(list) === "[object Array]" ||
            toString.call(list) === "[object Arguments]" ||
            toString.call(list) === "[object NodeList]" ||
            toString.call(list) === "[object HTMLCollection]" ||
            toString.call(list) === "[object HTMLOptionsCollection]");
    }

    /** Returns a version of `value` that is an actual Array. */
    function toList(value) {
        // Special case for actual arrays, there's no need to do any
